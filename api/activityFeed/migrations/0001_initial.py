...
import api.activityFeed.models
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('file', models.FileField(upload_to=api.activityFeed.models.upload_files_to, verbose_name='Изображение')),
            ],
            options={
                'verbose_name': 'Файл',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('image', models.ImageField(upload_to=api.activityFeed.models.upload_images_to, verbose_name='Изображение')),
            ],
            options={
